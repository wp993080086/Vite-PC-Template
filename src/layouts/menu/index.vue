	...
	<div id="left_menu" :style="{ width: isCollapse ? '64px' : '210px' }">
		<el-scrollbar>
			...
			>
				...
				<template v-for="menu in menuState.menuList" :key="menu.path">
					<template v-if="menu.children && menu.children.length > 0">
						<el-sub-menu :path="menu.path">
							<template #title>
...
import MenuItem from '@/layouts/menu/menu-item.vue'

const Router = useRouter()
const menuState = reactive({
	menuList: appStore.menuModule.menuList,
	openeds: ['/'],
...
watch(
	...
	(newValue) => {
		menuState.activeMenu = newValue.meta.activeMenu as string
	},
